...
namespace qbehaviour_adaptivemooptnopenalty;
...
/**
 * Unit tests for the adaptive (no penalties) behaviour for MooPT questions.
 *
...
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    protected function get_does_not_contain_penalty_info_expectation() {
        $penaltyinfo = get_string('gradingdetailspenalty', 'qbehaviour_adaptivemoopt', 'XXXXX');
    ...
    protected function get_does_not_contain_total_penalty_expectation() {
        $penaltyinfo = get_string('gradingdetailspenaltytotal', 'qbehaviour_adaptivemoopt', 'XXXXX');
        $penaltypattern = '/'.str_replace('XXXXX', '\\w*', preg_quote($penaltyinfo, '/')).'/';
        return new \question_no_pattern_expectation($penaltypattern);
    }
